...
client.login("Nzg3NzQzODU1ODc2Mzc0NTM4.X9ZZog.jWzaZ1LfJSmiUXeI1dUetW67P70");
...
client.on("ready", () => {
    ...
    client.user.setPresence({ activity: { name: `5 İnvite Premium`, type: "STREAMING", url: "https://discord.gg/qjJH2EeNaB" } })
